...
const Orders = () => {
    ...
    const cart = [
        { id: 3, name: "Pollo", price: 1.00, quantity: 4, category: "normal" },
        
        // { id: 9, name: "Tajada / Queso", price: 1.50, quantity: 64, category: "especial" },
        
        // { id: 17, name: "Camarón", price: 2.00, quantity: 64, category: "gourmet" },
        
        { id: 21, name: "Parchita", price: 1.00, quantity: 2, category: "bebida" },
